...
const TechStackTabs = () => {
    ...
    return (
        <div className="bg-gray-50 text-black py-24 px-4 md:px-12 relative overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6">
                        Our Powerful <span className="text-gradient">Tech Stack</span>
                    </h2>
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-16">
                    {Object.keys(techStack).map((tab) => (
                        <button
                            ...
                            className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 text-sm md:text-base border-2 ${activeTab === tab
                                    ? "bg-primary text-white border-primary shadow-lg scale-105"
                                    : "bg-white text-gray-600 border-transparent hover:border-blue-100 hover:bg-blue-50"
                                }`}
                        >
                            {tab}
                        </button>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {techStack[activeTab]?.map((tech, index) => (
                                ...
                                >
                                    <div className="w-24 h-24 md:w-28 md:h-28 bg-white rounded-3xl flex items-center justify-center shadow-sm hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 group-hover:-translate-y-2 relative overflow-hidden">
