            ...
            {isVisible && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-lg bg-primary rounded-3xl overflow-hidden shadow-2xl border border-white/10"
                    >
                        {/* Close Button */}
                        <button
                            onClick={closePopup}
                            className="absolute top-4 right-4 z-20 bg-white/10 hover:bg-white/20 text-white rounded-full p-1 transition-colors backdrop-blur-md"
                        >
                            <X size={20} />
                        </button>
                        ...
                        <div className="relative z-10 p-8 flex flex-col items-center text-center">
                            ...
                            <motion.h2
                                ...
                                className="text-5xl font-black text-secondary italic mb-2 drop-shadow-[0_0_15px_rgba(0,200,224,0.4)]"
                            >
                                WAIT!
                            </motion.h2>
                            ...
                            <motion.div
                                ...
                                className="relative mb-8 transform rotate-[-5deg]"
                            >
                                <div className="bg-gradient-to-r from-red-600 to-red-500 text-white px-8 py-4 rounded-xl shadow-2xl border border-white/20 flex items-center gap-4 relative overflow-hidden group">
                            ...
                            <motion.div
                                ...
                                className="bg-white/10 backdrop-blur-md border border-white/10 text-white font-bold text-lg py-2 px-6 w-full transform -skew-x-12 mb-8 shadow-lg"
                            >
                            ...
                            >
                                <Link
                                    href="/contact"
                                    onClick={closePopup}
                                    className="inline-block bg-secondary hover:bg-cyan-400 text-primary text-xl font-bold px-8 py-3 rounded-full shadow-[0_0_20px_rgba(0,200,224,0.4)] hover:shadow-[0_0_30px_rgba(0,200,224,0.6)] hover:scale-105 transition-all duration-300"
                                >
                                    Snatch The Deal
                                </Link>
                            </motion.div>
